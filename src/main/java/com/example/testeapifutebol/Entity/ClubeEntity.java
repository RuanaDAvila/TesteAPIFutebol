 ...
 */
    ...
    // Nome do clube (obrigatório, mínimo 2 caracteres)
    @Column(nullable = false)
    private String nome;

    // Sigla do estado onde o clube tem sede (obrigatório, 2 caracteres)
    @Column(nullable = false, length = 2)
    private String estado;

    // Data de criação do clube (obrigatório, não pode ser no futuro)
    @Column(nullable = false)
    ...
    // Construtor com todos os campos (facilita criação de objetos)
